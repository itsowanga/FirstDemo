...
# Main class
MAIN_CLASS = AutomatonSimulation

# Default arguments (update these if needed)
ARGS ?= input/'1001_by_1001_all_8.csv' output/1001_by_1001_all_8.png  # Replace 'default_arguments' with your specific default arguments, if any
